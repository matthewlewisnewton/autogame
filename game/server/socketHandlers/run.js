/**
 * In-run and run-lifecycle socket handlers (movement, cards, quests, loot).
 * Card combat stays delegated to cardEffects.handleUseCard.
 */
...
function register(socket, ctx) {
  const { io, withLobbyFromSocket, withLobbyPlayer, broadcastLobbyUpdate, savePlayerData, applyLayoutForQuest } = ctx;
