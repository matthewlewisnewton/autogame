const { offerCardTrade, respondCardTrade } = require('../progression');

/**
 * Lobby-phase card trade offer/response handlers.
 */
function register(socket, ctx) {
  const { savePlayerData, withLobbyPlayer, findSocketByPlayerId } = ctx;
