...
const {
  MAX_MAGIC_STONES: SHARED_MAX_MAGIC_STONES,
  STARTING_MAGIC_STONES: SHARED_STARTING_MAGIC_STONES,
  HAND_SLOT_FILL_ORDER: SHARED_HAND_SLOT_FILL_ORDER,
  APPEARANCE_CHANGE_COST: SHARED_APPEARANCE_CHANGE_COST,
} = require('../shared/constants.json');
...
const APPEARANCE_CHANGE_COST = SHARED_APPEARANCE_CHANGE_COST;
