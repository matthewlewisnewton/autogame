...
describe('canyon_descent Tier 2 catalog and layout', () => {
  ...
  it('Tier 2 rigid canyon geometry is stable across seeds; Tier 1 default varies ramp count', () => {
    ...
    expect(structuralSnapshot(tier2SeedA)).toEqual(structuralSnapshot(tier2SeedB));
    ...
    const geometryDiffers =
      JSON.stringify(structuralSnapshot(tier1AtTier2Seed)) !==
      JSON.stringify(structuralSnapshot(tier2AtTier2Seed));
...
describe('canyon_descent Tier 2 deploy spawns', () => {
  ...
  it('places Tier 2 enemies on walkable floor with plateau and canyon band coverage', () => {
