...
describe('Socket Integration — Quest Selection', () => {
	...
	it('selects a valid quest and broadcasts to all clients', async () => {
		...
		expect(u1.quests.map(q => q.id)).toEqual(['training_caverns', 'crystal_rescue', 'arena_trials', 'crucible_duel', 'vault_onslaught', 'rift_convergence', 'frost_crossing', 'canyon_descent', 'ember_descent', 'spire_ascent', 'annex_escort', 'endless_siege']);
