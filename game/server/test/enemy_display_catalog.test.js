...
const ENEMY_TYPES = ['grunt', 'skirmisher', 'miniboss', 'annex_overseer', 'arena_champion', 'spire_warden', 'permafrost_warden', 'spawner', 'field_medic', 'glacial_thrower', 'ember_wraith'];
