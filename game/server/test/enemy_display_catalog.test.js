...
const ENEMY_TYPES = ['grunt', 'skirmisher', 'miniboss', 'annex_overseer', 'arena_champion', 'crucible_sovereign', 'spire_warden', 'cinder_warden', 'magma_colossus', 'permafrost_warden', 'glacial_tyrant', 'riftbound_colossus', 'citadel_sovereign', 'spawner', 'field_medic', 'glacial_thrower', 'ember_wraith', 'void_seraph', 'rime_drifter'];
