...
|------|----------------------|-------------------|---------|-----|--------|
| player.glb | player | Quaternius "Universal Base Characters" — Superhero Male FullBody (Standard glTF) | CC0 | https://quaternius.com/packs/universalbasecharacters.html | spike |
