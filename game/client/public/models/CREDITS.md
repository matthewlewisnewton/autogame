...
|------|----------------------|-------------------|---------|-----|--------|
| player.glb | player | Autogame original (`scripts/generate-player-glb.mjs`) | Project-owned | `player.glb.license.md` | spike — base humanoid for customization epic (181–188); not wired in renderer |
