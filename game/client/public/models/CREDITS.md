...
|------|----------------------|-------------------|---------|-----|--------|
| player.glb | player | Quaternius "Universal Base Characters" — Superhero_Male_FullBody (Standard CC0 tier; see `game/docs/MODEL_SPIKE.md` for proportion target) | CC0 | https://quaternius.com/packs/universalbasecharacters.html | spike base — six proportion morphs (sub-ticket 04) |
