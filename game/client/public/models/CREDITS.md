...
|------|----------------------|-------------------|---------|-----|--------|
| player.glb | player | Quaternius Universal Base Characters — Superhero Male FullBody (Standard zip) | CC0 | https://quaternius.com/packs/universalbasecharacters.html | spike |
