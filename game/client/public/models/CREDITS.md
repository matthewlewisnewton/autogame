...
|------|----------------------|-------------------|---------|-----|--------|
| player.glb | player | Quaternius "Universal Base Characters" — Superhero Male (Standard CC0; Regular Male tier in Source kit) | CC0 | https://quaternius.itch.io/universal-base-characters | spike base — normalized, not wired in renderer (187) |
