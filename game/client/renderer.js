...
export const ENEMY_GEOMETRY = {
	...
	citadel_sovereign: { type: 'cone', radius: 1.45, height: 3.1, segments: 16, color: 0x581c87, emissive: 0xa855f7, emissiveIntensity: 0.5 },
...
export const ENEMY_ATTACK_VISUAL = {
	...
	citadel_sovereign: { style: 'cone', coneAngle: (2 * Math.PI) / 3, range: 6.5, color: 0xc084fc, emissive: 0x7e22ce },
