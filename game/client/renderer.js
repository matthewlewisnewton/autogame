...
const ENEMY_GEOMETRY = {
	...
	annex_overseer: { type: 'cone', radius: 1.1, height: 2.4, segments: 14, color: 0x0d9488, emissive: 0x14b8a6, emissiveIntensity: 0.5 },
	arena_champion: { type: 'cone', radius: 1.3, height: 3.0, segments: 16, color: 0xffaa00, emissive: 0xcc3300, emissiveIntensity: 0.5 },
	spire_warden: { type: 'cone', radius: 1.0, height: 2.2, segments: 12, color: 0x3388cc, emissive: 0x55aaff, emissiveIntensity: 0.4 },
	canyon_warden: { type: 'cone', radius: 1.0, height: 2.2, segments: 12, color: 0xcc8800, emissive: 0xffaa44, emissiveIntensity: 0.4 },
