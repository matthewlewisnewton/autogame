...
const esmPath = path.resolve(__dirname, 'boothZones.esm.js');
...
const mod = (new Function(
	'"use strict";\n' +
	source + '\n' +
	'return { findBoothInRange, BOOTH_INTERACT_RADIUS };'
))();
