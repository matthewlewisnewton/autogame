// ── cosmeticAppearance CJS wrapper ──
// Thin wrapper that loads the canonical ESM source at require time.
// The ESM file (cosmeticAppearance.esm.js) is the single source of truth;
// this file must never contain a duplicated function body.
//
// ESM eval-bridge constraints:
//   Supported in cosmeticAppearance.esm.js — plain `export function …`,
...
const esmPath = path.resolve(__dirname, 'cosmeticAppearance.esm.js');
...
const mod = (new Function(
	'"use strict";\n' +
	source + '\n' +
	'return { hasAppearanceFieldChanges, APPEARANCE_FIELD_KEYS };'
))();
