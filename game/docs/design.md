...
## Combat Mechanics
Instead of standard weapons, players equip a deck of up to 24 cards. At any time, they hold a "hand" of up to 6 cards (opening hand dealt is 4), each mapped to an input button.
