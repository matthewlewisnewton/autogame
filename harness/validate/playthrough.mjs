...
import {
	runCanyonTelepipeNewSortieStep,
...
function buildAssertions(summary, preset) {
	...
	if (!isStageRevalidationPreset(preset, summary)) {
		return base;
	}
...
async function main() {
	...
	try {
		...
		if (runsRoomsFull && page && !runsStageRevalidationFull) {
