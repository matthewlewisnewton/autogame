# Cleanup nits from hud-objective-line-shows-only-quest-title-for-stage-boss-and-iykh

> **Staleness note.** This follow-up ticket was written against commit
> `56b707ef` (2026-06-11). The codebase may have moved on since it was filed —
> before acting, re-check every file path and code reference below
> against the CURRENT code, and skip any nit that is already resolved.

Minor, non-blocking nits the reviewer noted while passing `hud-objective-line-shows-only-quest-title-for-stage-boss-and-iykh`.
