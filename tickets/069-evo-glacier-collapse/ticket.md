# Ticket: Evolution - Glacier Collapse
...
## Goal
Implement the evolved form of **Frost Nova**: the **Glacier Collapse**.

## Requirements
- **Stats**: Inherit base stats from Frost Nova but apply a significant buff (e.g., +50% damage).
- **Special Effect**: Deals massive damage to frozen targets.
- **Visuals**: Define a new icon and color theme for this card.
- **Recipe**: This card is obtained by evolving a `Frost Nova +10`.

## Implementation Tasks
- [x] Add `glacier_collapse` definition to `CARD_DEFS`.
...
## Verification Plan
1. Evolve a Frost Nova into a Glacier Collapse.
