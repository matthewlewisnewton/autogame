...
project docs so tickets 186–191 share one canonical naming scheme.
...
- `game/client/public/models/README.md` summarizes the contract for asset authors
  ...
  and `CREDITS.md`.
- No `.glb` binary is added in this sub-ticket (asset import is sub-ticket 02).
...
- Do **not** modify `game/client/renderer.js`, server cosmetic code, or the model
  registry (tickets 161 / 187 own runtime wiring).
