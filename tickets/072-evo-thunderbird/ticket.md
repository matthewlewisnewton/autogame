...
## Goal
Implement the evolved form of **Storm Eagle**: the **Thunderbird**.

## Requirements
- **Stats**: Inherit base stats from Storm Eagle but apply a significant buff (e.g., +50% damage).
- **Special Effect**: Projectiles now chain between nearby enemies.
- **Visuals**: Define a new icon and color theme for this card.
- **Recipe**: This card is obtained by evolving a `Storm Eagle +10`.

## Implementation Tasks
- [x] Add `thunderbird` definition to `CARD_DEFS`.
...
## Verification Plan
1. Evolve a Storm Eagle into a Thunderbird.
